...
public class MBONewcustomerOrderUsingChequewithSharedAgent {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		SelectCheque.click();
		WebElement ChequeNumber = driver.findElement(By.id("order-cheque-no"));
		ChequeNumber.sendKeys("123456");
		WebElement ChequeRootNumber = driver.findElement(By.id("order-routing-number"));
		ChequeRootNumber.sendKeys("5500000");
		WebElement AcNumber = driver.findElement(By.id("order-account-no"));
		AcNumber.sendKeys("98765432");
		WebElement BankName = driver.findElement(By.id("order-bank-name"));
		BankName.sendKeys("AOB");
