...
public class MBONewcustomerorderusingCreditCard {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Email.sendKeys("rojitest82@gmail.com");
		...
		Select Cardselect = new Select(SelectCard );
		Cardselect.selectByValue("mastercard");
		WebElement CardholderName = driver.findElement(By.id("cardholder-name"));
		CardholderName.sendKeys("Test11");
		WebElement CardNumber = driver.findElement(By.id("card_num_temp"));
		CardNumber.sendKeys("5500000000000004");
	    WebElement CardExpMonth = driver.findElement(By.id("card_mon"));
		Select ExpMonth = new Select(CardExpMonth );
		ExpMonth.selectByValue("08");
		WebElement CardExpYear = driver.findElement(By.id("card_year_id"));
		...
		WebElement SharedOrderYes = driver.findElement(By.id("shared_order_user_list"));
		Select SharedAgent = new Select(SharedOrderYes );
		SharedAgent.selectByValue("36");
